...
import {
  ...
  useCheckRFXPasswordMutation,
} from '@/app/(features)/vendor/_api/bid-response.api';
...
const CheckPassword = () => {
  ...
  // const [checkPassword, { isLoading: isChecking }] = useCheckRFXPasswordMutation();
  // Functions
  ...
  //     // JSON.parse(sessionStorage.getItem('password') ?? '').rfxId === id
  //   ) {
  //     router.push(`/invitations-workspace/prepare-bid/${id}/bid-configuration`);
  //   }
  // }, [id, router]);
  useEffect(() => {
