...
const Page = () => {
  const CardData = [
    ...
    },
    {
      ...
      description:
        'Duis aute irure dolor in  in  velit esse  dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
      icon: IconUser,
    },
    {
      title: 'Lorem ipsum dolor sit amet,  adipiscing',
      description:
        'Duis aute irure dolor in reprehenderit in  velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
      icon: IconUser,
    },
    {
