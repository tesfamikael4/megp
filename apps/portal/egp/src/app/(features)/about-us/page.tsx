...
const Page = () => {
  const CardData = [
    ...
    },
    {
      ...
      description:
        'Duis aute irure dolor in  in  velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
      icon: IconUser,
    },
    {
