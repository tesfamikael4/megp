...
import { useCreateMutation, useListQuery } from '../rfx/_api/note.api';
import { useRevisionApprovalsMutation } from '@/store/api/rfx/rfx.api';
...
export function PDFHighlighter({
  ...
  const [setRevisionsApprovals] = useRevisionApprovalsMutation();
