...
} from '@/app/(features)/preparation/_api/item/labour.api';
...
import { LabourFormDetail } from './labour-form-detail';
    ...
    >
      ...
      >
        <div className="flex justify-between">
          <h2 className="font-medium text-lg capitalize">Labour</h2>
          <IconX onClick={close} />
        </div>
        <Divider mt={'md'} mb={'md'} />
