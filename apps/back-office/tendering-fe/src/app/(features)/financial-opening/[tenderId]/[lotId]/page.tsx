...
import { LotOverview } from '@/app/(features)/opening/_components/lot-overview';
import { OPENING_ASSESSMENT } from '@/app/(features)/opening/_constants/data';
...
export default function BidOpening() {
        ...
        render: (record) => (
          <ActionIcon
            ...
            onClick={(e) => {
              e.stopPropagation();
              router.push(
                `/financial-opening/${tenderId}/${lotId}/${record.bidder.bidderId}`,
              );
            }}
          >
  ...
  return (
    <>
      <LotOverview basePath={`/financial-opening`} />
