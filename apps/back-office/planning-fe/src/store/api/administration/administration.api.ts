...
export const administrationApi = createApi({
    ...
    baseQuery: fetchBaseQuery({
        baseUrl: process.env.NEXT_PUBLIC_ADMINISTRATION_API ?? '/administration/api/',
    }),
    endpoints: (builder) => ({
...
export const { useGetItemMasterQuery, useLazyGetUnitOfMeasurementsQuery } = administrationApi;
