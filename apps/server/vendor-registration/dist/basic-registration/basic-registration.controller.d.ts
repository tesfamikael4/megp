...
export declare class BasicRegistrationController {
    ...
    create(createBasicRegistrationDto: CreateBasicRegistrationDto): Promise<import("./dto/basic-registration.dto").BasicRegistrationResponseDto>;
    findOne(id: string): Promise<import("./dto/basic-registration.dto").BasicRegistrationResponseDto>;
    findAll(query: CollectionQuery): Promise<import("@api-data").DataResponseFormat<import("./dto/basic-registration.dto").BasicRegistrationResponseDto>>;
    update(id: string, updateBasicRegistrationDto: UpdateBasicRegistrationDto): Promise<import("./dto/basic-registration.dto").BasicRegistrationResponseDto>;
