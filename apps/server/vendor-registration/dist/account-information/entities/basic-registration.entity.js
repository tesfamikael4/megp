...
const account_information_entity_1 = require("./account-information.entity");
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], BasicRegistration.prototype, "accountInformationId", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => account_information_entity_1.AccountInformation, (accountInformation) => accountInformation.basicRegistration),
    (0, typeorm_1.JoinColumn)({ name: 'accountInformationId' }),
    __metadata("design:type", account_information_entity_1.AccountInformation)
], BasicRegistration.prototype, "accountInformation", void 0);
