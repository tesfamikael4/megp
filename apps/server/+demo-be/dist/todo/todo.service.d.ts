...
export declare class TodoService {
    ...
    constructor(repository: Repository<Todo>, todoItemRepository: Repository<TodoItem>, todoItemNewRepository: Repository<TodoItemNew>);
    ...
    updateTodoItem(id: string, todoItem: UpdateTodoItemDto): Promise<TodoItemResponseDto>;
    removeTodoItem(id: string): Promise<void>;
    addTodoItemNew(todoItemNew: CreateTodoItemNewDto): Promise<TodoItemNewResponseDto>;
    updateTodoItemNew(id: string, todoItemNew: UpdateTodoItemNewDto): Promise<TodoItemNewResponseDto>;
