...
export declare class TodoController {
  ...
  ): Promise<import('./dto/todo-item.dto').TodoItemResponseDto>;
  editTodoItem(
    id: string,
    createTodoItemDto: UpdateTodoItemDto,
  ): Promise<import('./dto/todo-item.dto').TodoItemResponseDto>;
  removeTodoItem(id: string): Promise<void>;
  addTodoItemNew(
    createTodoItemNewDto: CreateTodoItemNewDto,
  ): Promise<import('./dto/todo-item-new.dto').TodoItemNewResponseDto>;
  editTodoItemNew(
    id: string,
    createTodoItemNewDto: UpdateTodoItemNewDto,
  ): Promise<import('./dto/todo-item-new.dto').TodoItemNewResponseDto>;
