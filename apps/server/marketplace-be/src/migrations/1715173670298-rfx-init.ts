...
export class RfxInit1715173670298 implements MigrationInterface {
  name = 'RfxInit1715173670298';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."rfx_items_status_enum" AS ENUM('DRAFT', 'PENDING', 'REVIEW', 'SUBMITTED', 'COMPLETED', 'APPROVED', 'REJECTED')`,
    );
    await queryRunner.query(
