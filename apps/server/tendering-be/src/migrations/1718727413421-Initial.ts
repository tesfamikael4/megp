...
export class Initial1718727413421 implements MigrationInterface {
  name = 'Initial1718727413421';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "procurement_technical_teams" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "userId" character varying NOT NULL, "userName" character varying, "isTeamLead" boolean NOT NULL, CONSTRAINT "PK_580667c2adc45b5f32acc7b4c77" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "procurement_mechanisms" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "PRProcurementMechanisms" json NOT NULL, "invitationType" character varying, "marketApproach" character varying, "stageType" character varying, "stage" integer, CONSTRAINT "REL_3182144677e584be4c8019c9f7" UNIQUE ("tenderId"), CONSTRAINT "PK_8685ab6b89ae9fe4d5319ab84ad" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."bid_response_tenders_documenttype_enum" AS ENUM('RESPONSE', 'TECHNICAL_RESPONSE', 'FINANCIAL_RESPONSE')`,
    );
    await queryRunner.query(
      `CREATE TABLE "bid_response_tenders" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidRegistrationId" uuid NOT NULL, "documentType" "public"."bid_response_tenders_documenttype_enum" NOT NULL, "key" character varying NOT NULL, "value" text NOT NULL, CONSTRAINT "UQ_6888c9fd30987aa3249fb9c08c1" UNIQUE ("bidRegistrationId", "key"), CONSTRAINT "PK_fd5bb5d22f75d1c67e00c0baffe" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."shared_bidder_keys_envelopetype_enum" AS ENUM('RESPONSE', 'TECHNICAL_RESPONSE', 'FINANCIAL_RESPONSE')`,
    );
    await queryRunner.query(
      `CREATE TABLE "shared_bidder_keys" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidRegistrationId" uuid NOT NULL, "envelopeType" "public"."shared_bidder_keys_envelopetype_enum" NOT NULL, "privateKey" character varying NOT NULL, "contactName" character varying, "contactPhoneNumber" character varying, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "UQ_436cc2315ddd13e6ac2c2f46347" UNIQUE ("bidRegistrationId", "envelopeType"), CONSTRAINT "PK_7238236a51e65ea6f7155260843" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."opened_bid_response_tenders_documenttype_enum" AS ENUM('RESPONSE', 'TECHNICAL_RESPONSE', 'FINANCIAL_RESPONSE')`,
    );
    await queryRunner.query(
      `CREATE TABLE "opened_bid_response_tenders" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidRegistrationId" uuid NOT NULL, "documentType" "public"."opened_bid_response_tenders_documenttype_enum" NOT NULL, "key" character varying NOT NULL, "value" text NOT NULL, CONSTRAINT "UQ_1b075bd20b690d2f3c970a5a0b2" UNIQUE ("bidRegistrationId", "key"), CONSTRAINT "PK_7295e696b7d02b913d6977fa050" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bidders_comparisons" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidRegistrationDetailId" uuid NOT NULL, "itemId" uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000', "milestoneNum" "public"."bidders_comparisons_milestonenum_enum" NOT NULL, "milestoneTxt" "public"."bidders_comparisons_milestonetxt_enum" NOT NULL, "bidderStatus" "public"."bidders_comparisons_bidderstatus_enum" NOT NULL, "bidderStatusTxt" "public"."bidders_comparisons_bidderstatustxt_enum" NOT NULL, "technicalScore" integer, "adjustedTechnicalScore" integer, "technicalRank" integer, "financialScore" integer, "adjustedFinancialScore" integer, "financialRank" integer, "totalScore" integer, "Rank" integer, "isCurrent" boolean NOT NULL DEFAULT true, "passFail" boolean NOT NULL, "version" integer NOT NULL DEFAULT '1', CONSTRAINT "PK_0c1da12cd4af778adc5174ba456" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "spd_preliminary_evaluations" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "spdId" uuid NOT NULL, "criteria" character varying NOT NULL, "type" character varying NOT NULL, "itbReference" character varying NOT NULL, "itbDescription" text, "bidFormId" uuid NOT NULL, CONSTRAINT "PK_c1e559d384a059e670b0adf7bce" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_professional_settings" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "spdId" uuid NOT NULL, "requirement" character varying NOT NULL, "bidFormId" uuid NOT NULL, "validation" jsonb NOT NULL, CONSTRAINT "PK_893158452f6aaab98a63fa15ecd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "technical_scoring_assessments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidRegistrationDetailId" uuid NOT NULL, "evaluatorId" uuid NOT NULL, "evaluatorName" character varying NOT NULL, "totalPoints" integer NOT NULL, "submit" boolean NOT NULL, "version" integer NOT NULL DEFAULT '1', CONSTRAINT "PK_605f5f66df18d57bd5f386bffea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "technical_scoring_assessments_details" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "technicalScoringAssessmentId" uuid NOT NULL, "eqcTechnicalScoringId" uuid NOT NULL, "remark" character varying, "pointsAwarded" integer NOT NULL, "maxPoints" integer NOT NULL, "isComplete" boolean NOT NULL DEFAULT false, "parentId" uuid, CONSTRAINT "PK_7f25e47d658de960c4192460a22" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "eqc_technical_scorings" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "parentId" uuid, "requirement" character varying NOT NULL, "requirementCondition" character varying NOT NULL, "point" integer NOT NULL, "bidFormId" uuid NOT NULL, "spdTechnicalScoringId" uuid, "spdTechnicalScoringParentId" uuid, "isProfessional" boolean NOT NULL, "hasProfessional" boolean NOT NULL, "validation" jsonb NOT NULL, "isRequired" boolean NOT NULL, CONSTRAINT "PK_b77fd2261dfcadd1bf7b7ce220b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "technical_qualification_assessment_details" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "technicalQualificationAssessmentId" uuid NOT NULL, "eqcQualificationId" uuid NOT NULL, "qualified" "public"."technical_qualification_assessment_details_qualified_enum" NOT NULL DEFAULT 'NOT_DONE', "remark" character varying, CONSTRAINT "PK_00d2d8056476521cfbe6dab4ec7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "eqc_qualifications" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "factor" character varying NOT NULL, "requirement" character varying NOT NULL, "category" character varying NOT NULL, "singleEntityCondition" jsonb NOT NULL, "jvEachPartnerCondition" jsonb NOT NULL, "jvCombinedPartnerCondition" jsonb NOT NULL, "jvAtleastOnePartnerCondition" jsonb NOT NULL, "order" integer NOT NULL, "bidFormId" uuid NOT NULL, "itbDescription" character varying, "itbReference" character varying NOT NULL, "isRequired" boolean NOT NULL, "spdQualificationId" uuid, CONSTRAINT "PK_388eb2d21f4348e91352b603d4d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_qualifications" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "spdId" uuid NOT NULL, "category" character varying NOT NULL, "factor" character varying NOT NULL, "requirement" character varying NOT NULL, "bidFormId" uuid NOT NULL, "itbReference" character varying NOT NULL, "itbDescription" text, CONSTRAINT "PK_d512ad5a2d5f6a790a5a5e793d0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_bid_forms" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "code" character varying NOT NULL, "type" character varying NOT NULL, "documentDocx" jsonb, "documentPdf" jsonb, "spdId" uuid NOT NULL, CONSTRAINT "PK_fcb204245fba67ea286ed89be61" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_technical_scoring" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "spdId" uuid NOT NULL, "parentId" uuid, "requirement" character varying NOT NULL, "bidFormId" uuid NOT NULL, "isProfessional" boolean NOT NULL, "validation" jsonb NOT NULL, CONSTRAINT "PK_94c7ee37dd96288ad502ea3e8cd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_preference_margins" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "spdId" uuid NOT NULL, "condition" character varying NOT NULL, "description" character varying NOT NULL, "margin" character varying NOT NULL, "itbReference" character varying NOT NULL, "itbDescription" text, CONSTRAINT "PK_b1cea0ea1235afb0b77cb29aaa7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_templates" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying NOT NULL, "documentDocx" jsonb, "documentPdf" jsonb, "spdId" uuid NOT NULL, CONSTRAINT "PK_e2d7118c5872d3f54f78ab3609a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_contract_forms" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "code" character varying NOT NULL, "type" character varying NOT NULL, "documentDocx" jsonb, "documentPdf" jsonb, "spdId" uuid NOT NULL, CONSTRAINT "PK_92b8362bdbed79660313dd9c642" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tender_spds" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "spdId" uuid NOT NULL, "bds" jsonb, "scc" jsonb, CONSTRAINT "REL_0d09038a7c2856a68c38b8a9ff" UNIQUE ("tenderId"), CONSTRAINT "PK_2301fcddf238ba9c4916d39b1de" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_documentary_evidences" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "spdId" uuid NOT NULL, "checkOnFirstCompliance" boolean NOT NULL, "checkOnFirstOpening" boolean NOT NULL, "checkOnSecondCompliance" boolean NOT NULL, "checkOnSecondOpening" boolean NOT NULL, "evidenceTitle" character varying NOT NULL, "evidenceType" character varying NOT NULL, CONSTRAINT "PK_b717c9ee36bfa062c4ffb923a38" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "governingRule" jsonb, "name" character varying NOT NULL, "description" character varying NOT NULL, "marketType" character varying NOT NULL, "procurementCategory" character varying NOT NULL, "isActive" boolean NOT NULL, CONSTRAINT "PK_c048f166470e0a788481a2a744c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "spd_opening_checklists" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "spdId" uuid NOT NULL, "name" character varying NOT NULL, "isBoolean" boolean NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_3b76ae674bd35534bade3cd3971" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bid_opening_checklist_assessments" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "lotId" uuid NOT NULL, "bidRegistrationDetailId" uuid NOT NULL, "bidderId" uuid NOT NULL, "bidderName" character varying NOT NULL, "openerId" uuid NOT NULL, "openerName" character varying NOT NULL, "isTeamAssessment" boolean NOT NULL DEFAULT false, "qualified" "public"."bid_opening_checklist_assessments_qualified_enum" NOT NULL DEFAULT 'NOT_DONE', "submit" boolean NOT NULL DEFAULT false, "version" integer NOT NULL DEFAULT '1', CONSTRAINT "PK_741a4d4bb9a8f8fd4209ccbd3cb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bid_opening_checklist_assessment_details" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidOpeningChecklistAssessmentId" uuid NOT NULL, "spdOpeningChecklistId" uuid NOT NULL, "qualified" "public"."bid_opening_checklist_assessment_details_qualified_enum" NOT NULL DEFAULT 'NOT_DONE', "remark" character varying, CONSTRAINT "UQ_34ed90ddb8b208ea7e2bcdc9fcf" UNIQUE ("bidOpeningChecklistAssessmentId", "spdOpeningChecklistId"), CONSTRAINT "PK_999d421c2e7e7ac4efa03632660" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."bid_registration_details_status_enum" AS ENUM('NOT_SUBMITTED', 'SUBMITTED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "bid_registration_details" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidRegistrationId" uuid NOT NULL, "lotId" uuid NOT NULL, "status" "public"."bid_registration_details_status_enum" NOT NULL DEFAULT 'NOT_SUBMITTED', "technicalItems" text array, "financialItems" text array, "document" jsonb, CONSTRAINT "UQ_e8f0046094e3a07232d14c853ab" UNIQUE ("bidRegistrationId", "lotId"), CONSTRAINT "PK_4d167389b3f45777e23b17a6a77" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "technical_responsiveness_assessment_details" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "technicalResponsivenessAssessmentId" uuid NOT NULL, "sorTechnicalRequirementId" uuid NOT NULL, "qualified" "public"."technical_responsiveness_assessment_details_qualified_enum" NOT NULL DEFAULT 'NOT_DONE', "remark" character varying, CONSTRAINT "UQ_2a5dc04a81e364246e1dfbe2259" UNIQUE ("sorTechnicalRequirementId", "technicalResponsivenessAssessmentId"), CONSTRAINT "PK_13f23813c1bfe40e9c286d51de5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_technical_requirements" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "sorType" character varying NOT NULL, "category" character varying NOT NULL, "requirement" character varying NOT NULL, "requirementCondition" character varying NOT NULL, "requirementType" character varying NOT NULL, "bidFormId" uuid NOT NULL, CONSTRAINT "PK_498fa212fe8dc80a6107e96f546" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_reimburseable_expenses" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "itemNumber" character varying NOT NULL, "description" character varying NOT NULL, "unit" character varying NOT NULL, "quantity" integer NOT NULL, "unitCost" integer NOT NULL, "cost" integer NOT NULL, CONSTRAINT "PK_86094dcad0a193cb9c804595397" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_bill_of_materials" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "payItem" character varying NOT NULL, "description" character varying NOT NULL, "unit" character varying NOT NULL, "quantity" integer NOT NULL, "rate" integer, "amount" integer, "code" character varying NOT NULL, "parentCode" character varying, CONSTRAINT "PK_b872c04b57d2922919011de135c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_equipments" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "itemNumber" character varying NOT NULL, "description" character varying NOT NULL, "unit" character varying NOT NULL, "quantity" integer NOT NULL, "rate" integer, "amount" integer, CONSTRAINT "PK_5889e95b0ac6069f9d5c7f5262f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_fees" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "category" character varying NOT NULL, "position" character varying NOT NULL, "nameOfStaff" character varying NOT NULL, "staffMonthRate" integer, "inputStaffMonth" integer NOT NULL, "rate" integer, CONSTRAINT "PK_6b9d5be14d3e030748fad6a07f4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_incidental_costs" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "itemNumber" character varying NOT NULL, "description" character varying NOT NULL, "country" character varying NOT NULL, "quantity" integer NOT NULL, "rate" integer, "amount" integer, "currency" character varying, CONSTRAINT "PK_96e7cf682c0cd2b1612aef4eb7f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_labors" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "itemNumber" character varying NOT NULL, "description" character varying NOT NULL, "unit" character varying NOT NULL, "quantity" integer NOT NULL, "rate" integer, "amount" integer, CONSTRAINT "PK_90dbcc809c576b65ef2ac80a37d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sor_documents" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "description" character varying NOT NULL, "attachment" jsonb NOT NULL, CONSTRAINT "PK_75b13abd98099f9a05a2c2063a6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."price_adjusting_factors_type_enum" AS ENUM('ADDITION', 'DEDUCTION', 'TAXES', 'TOTAL')`,
    );
    await queryRunner.query(
      `CREATE TABLE "price_adjusting_factors" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "itemId" uuid NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "amount" integer NOT NULL, "type" "public"."price_adjusting_factors_type_enum" NOT NULL, CONSTRAINT "PK_353506f04dff8a542177b9411bb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."formula_implementations_type_enum" AS ENUM('ADDITION', 'DEDUCTION', 'TAXES', 'TOTAL')`,
    );
    await queryRunner.query(
      `CREATE TABLE "formula_implementations" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "representation" character varying NOT NULL, "lotId" uuid NOT NULL, "type" "public"."formula_implementations_type_enum" NOT NULL, "itemId" uuid NOT NULL, "bidderId" uuid NOT NULL, "result" integer, CONSTRAINT "UQ_6454028972ebc8a7ffd9ce6657d" UNIQUE ("lotId", "name"), CONSTRAINT "PK_f7c96c429db8b2ff8780581bffc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "financial_bid_price_assessments" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "itemId" uuid NOT NULL, "formulaImplementationId" uuid NOT NULL, "bidderId" uuid NOT NULL, "evaluatorId" uuid NOT NULL, "evaluatorName" character varying NOT NULL, "isTeamLead" boolean NOT NULL, "offeredUnitPrice" integer NOT NULL, "calculatedBidUnitPrice" integer NOT NULL, CONSTRAINT "REL_933c02b8b6eda946034e76952c" UNIQUE ("formulaImplementationId"), CONSTRAINT "PK_cb35c0aa4b3e34cbb917703c9ec" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "financial_price_analyses" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "bidderId" uuid NOT NULL, "isComplete" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_ffaa4dc6b7b8789ba3ab961d8a6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "financial_price_analyses_details" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid NOT NULL, "financialPriceAnalysisId" uuid NOT NULL, "evaluatorId" uuid NOT NULL, "evaluatorName" character varying NOT NULL, "currency" character varying NOT NULL, "calculatedBidUnitPrice" integer NOT NULL, "marketUnitPrice" integer NOT NULL, "difference" integer NOT NULL, CONSTRAINT "PK_1ea21bbd8c9dec1be5c00631021" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."items_status_enum" AS ENUM('ACTIVE', 'CANCELED', 'RE-ADVERTISED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "items" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "itemCode" character varying NOT NULL, "procurementCategory" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "unitOfMeasure" character varying NOT NULL, "estimatedPrice" numeric(10,2) NOT NULL DEFAULT '0', "estimatedPriceCurrency" character varying NOT NULL, "marketPrice" numeric(10,2), "marketPriceCurrency" character varying, "hasBom" boolean NOT NULL, "metaData" jsonb, "status" "public"."items_status_enum" NOT NULL DEFAULT 'ACTIVE', CONSTRAINT "PK_ba5885359424c15ca6b9e79bcf6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tender_classifications" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "classification" jsonb NOT NULL, CONSTRAINT "PK_5c8e095ea8c8516a4370da8ea44" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tender_personals" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "position" character varying NOT NULL, "evaluated" boolean NOT NULL, "order" integer NOT NULL, CONSTRAINT "PK_d1a8a37d20b6130a8583bdf6825" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."bds_submissions_enveloptype_enum" AS ENUM('single envelop', 'two envelop')`,
    );
    await queryRunner.query(
      `CREATE TABLE "bds_submissions" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "submissionDeadline" TIMESTAMP WITH TIME ZONE NOT NULL, "openingDate" TIMESTAMP WITH TIME ZONE NOT NULL, "invitationDate" TIMESTAMP WITH TIME ZONE NOT NULL, "envelopType" "public"."bds_submissions_enveloptype_enum" NOT NULL, CONSTRAINT "REL_f4643c48139c99ed56b357ed5e" UNIQUE ("tenderId"), CONSTRAINT "PK_b5b417bdfc6f5fa01996a6c4c09" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "eqc_documentary_evidences" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "checkOnFirstCompliance" boolean NOT NULL, "checkOnFirstOpening" boolean NOT NULL, "checkOnSecondCompliance" boolean NOT NULL, "checkOnSecondOpening" boolean NOT NULL, "evidenceTitle" character varying NOT NULL, "evidenceType" character varying NOT NULL, "spdDocumentaryEvidenceId" uuid, CONSTRAINT "PK_41690111cede6e13a16fb9a2d82" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "eqc_due_diligences" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "requirement" character varying, "requirementCondition" character varying NOT NULL, CONSTRAINT "PK_9c693e4122a4543955808d94c99" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bds_generals" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "jointVentureAllowed" boolean NOT NULL, "maximumNumberOfMembers" integer NOT NULL, "subContractAllowed" boolean NOT NULL, "maximumPercentageContractingAllowed" numeric(14,2) NOT NULL DEFAULT '0', "clarificationDeadline" TIMESTAMP WITH TIME ZONE NOT NULL, "preBidConferenceRequired" boolean NOT NULL, "preBidConferenceDate" TIMESTAMP WITH TIME ZONE NOT NULL, "siteVisitAllowed" boolean NOT NULL, CONSTRAINT "REL_a9b475d7e1baf128ac85bd5990" UNIQUE ("tenderId"), CONSTRAINT "PK_d6e0368edc816d219b1e649b4af" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "bds_awards" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "percentageQuantityIncreased" integer NOT NULL, "percentageQuantityDecreased" integer NOT NULL, "negotiationAllowed" boolean NOT NULL, CONSTRAINT "REL_360a587c5c63482a136ec4a93d" UNIQUE ("tenderId"), CONSTRAINT "PK_d562f5d119de65df4b18dd8f855" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bds_evaluations" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "bidEvaluationCurrency" text NOT NULL, "evaluationMethod" "public"."bds_evaluations_evaluationmethod_enum" NOT NULL, "selectionMethod" "public"."bds_evaluations_selectionmethod_enum" NOT NULL, "awardType" "public"."bds_evaluations_awardtype_enum" NOT NULL, "technicalWeight" integer NOT NULL, "financialWeight" integer NOT NULL, "passingMark" integer NOT NULL, CONSTRAINT "REL_32110ff8c972bd861c32fdacb2" UNIQUE ("tenderId"), CONSTRAINT "PK_081f71b1010b0e8d30c8113264a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "bds_preparations" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "currencyOfTheBidForNationalBidders" jsonb NOT NULL, "currencyOfTheBidForInternationalBidders" jsonb NOT NULL, "incotermsEdition" character varying NOT NULL, "incotermType" character varying NOT NULL, "bidValidityPeriod" integer NOT NULL, CONSTRAINT "REL_19798e60cc425f76fd8c92ef7b" UNIQUE ("tenderId"), CONSTRAINT "PK_065f63f73ee399a52aa77aae961" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "bds_bid_securities" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "bidSecurityRequired" boolean NOT NULL, "bidSecurityAmount" integer, "bidSecurityCurrency" character varying, "bidSecurityForm" character varying NOT NULL, CONSTRAINT "REL_f74f982a3d5a91345ea8fd9686" UNIQUE ("lotId"), CONSTRAINT "PK_8fd567a4860c3c7311ada52bc4b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "scc_contract_deliverables" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "deliverable" text array NOT NULL, "deliverySchedule" integer NOT NULL, CONSTRAINT "PK_c0c61be27116a78e58e54138d00" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "scc_general_provisions" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "contractDuration" integer NOT NULL, "commencementDay" integer NOT NULL DEFAULT '1', "deliverySite" character varying NOT NULL, "contractType" character varying NOT NULL, CONSTRAINT "PK_4d9aa7f75432040d2aa083c39ae" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "scc_liabilities" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "warrantyPeriod" integer, "postWarrantyServicePeriod" integer, "liquidityDamage" integer NOT NULL DEFAULT '0', "liquidityDamageLimit" integer NOT NULL, CONSTRAINT "PK_001f88b8d869d57ab263d3b8cac" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "scc_payment_schedules" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "paymentSchedule" character varying NOT NULL, "paymentPercentage" integer NOT NULL, "order" integer NOT NULL, "requiredDocuments" text array NOT NULL, CONSTRAINT "PK_e5c64a4a278245ee8e09747ce21" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "scc_payment_terms" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "contractCurrency" text array NOT NULL, "paymentMode" text array NOT NULL, "advancePaymentAllowed" boolean NOT NULL DEFAULT true, "advancePaymentLimit" integer NOT NULL DEFAULT '0', "paymentReleasePeriod" integer NOT NULL, "latePaymentPenalty" integer NOT NULL, CONSTRAINT "PK_b561cbab1bef32331a72d820e86" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "notes" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "content" character varying NOT NULL, "key" character varying NOT NULL, "metadata" jsonb, "objectId" character varying NOT NULL, "objectType" character varying NOT NULL, CONSTRAINT "PK_af6206538ea96c4e77e9f400c3d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."revision_approvals_status_enum" AS ENUM('APPROVED', 'APPROVED_WITH_COMMENT', 'ADJUST_WITH_COMMENT')`,
    );
    await queryRunner.query(
      `CREATE TABLE "revision_approvals" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "userId" uuid NOT NULL, "status" "public"."revision_approvals_status_enum" NOT NULL DEFAULT 'APPROVED', CONSTRAINT "UQ_92ff2f55e29419ccad038e05121" UNIQUE ("tenderId", "userId"), CONSTRAINT "PK_5062ab2aef8191d1cc7484580b3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "bid_opening_minutes" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL, "remark" character varying, CONSTRAINT "PK_1ad73acb4a86c5d6582a79b8097" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "team_members" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "teamId" uuid NOT NULL, "personnelId" uuid NOT NULL, "personnelName" character varying NOT NULL, "isTeamLead" boolean NOT NULL, "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_6895239c93cce6b2cb97157755e" UNIQUE ("teamId", "personnelId"), CONSTRAINT "PK_ca3eae89dcf20c9fd95bf7460aa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "teams" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid, "tenderId" uuid NOT NULL, "envelopeType" "public"."teams_envelopetype_enum" NOT NULL, "teamType" "public"."teams_teamtype_enum" NOT NULL, CONSTRAINT "UQ_0e0f1ddb4f2fdb3b64ca3a41fe0" UNIQUE ("lotId", "teamType"), CONSTRAINT "PK_7e5523774a38b08a6236d322403" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."openings_status_enum" AS ENUM('PENDING', 'COMPLETED', 'CANCELED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "openings" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "teamId" uuid NOT NULL, "openingType" character varying NOT NULL, "status" "public"."openings_status_enum" NOT NULL DEFAULT 'PENDING', "isReportReady" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_206e900e22ac4e35801df59519a" UNIQUE ("teamId", "tenderId"), CONSTRAINT "REL_898061552c1476d5a0a8cc6598" UNIQUE ("tenderId"), CONSTRAINT "REL_2134bf9ff08b1d831c9941ccc1" UNIQUE ("teamId"), CONSTRAINT "PK_52465524569a0b0e856a64eb48b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bid_guarantee_releases" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "guaranteeId" uuid NOT NULL, "reason" character varying NOT NULL, "remark" character varying, "status" "public"."bid_guarantee_releases_status_enum" NOT NULL, CONSTRAINT "PK_673ce221bda99c9076442d1492f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."bid_guarantee_cancellations_status_enum" AS ENUM('REQUESTED', 'CANCELLED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "bid_guarantee_cancellations" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "guaranteeId" uuid NOT NULL, "reason" character varying NOT NULL, "remark" character varying, "status" "public"."bid_guarantee_cancellations_status_enum" NOT NULL, CONSTRAINT "PK_5075161d83c75f39eb15a1d9be4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bid_guarantees" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bidderId" uuid NOT NULL, "bidderName" character varying NOT NULL, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "lotId" uuid NOT NULL, "minValidityDate" integer, "revisedValidityDate" integer, "description" character varying NOT NULL, "contactPerson" jsonb NOT NULL, "hashValue" character varying, "amount" numeric(14,2) NOT NULL DEFAULT '0', "currency" character varying NOT NULL, "guarantorId" uuid NOT NULL, "guarantorName" character varying NOT NULL, "guarantorBranchId" uuid NOT NULL, "guarantorBranchName" character varying NOT NULL, "document" jsonb, "guaranteeReference" character varying, "referenceNumber" character varying, "status" "public"."bid_guarantees_status_enum" NOT NULL, CONSTRAINT "PK_c401506f883f8405a25e85a4b29" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."bid_bookmarks_status_enum" AS ENUM('BOOKMARKED', 'REGISTERED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "bid_bookmarks" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "bidderId" character varying NOT NULL, "bidderName" character varying NOT NULL, "status" "public"."bid_bookmarks_status_enum" NOT NULL DEFAULT 'BOOKMARKED', CONSTRAINT "UQ_da0d38e0dc6b4e7fc1538bb8f09" UNIQUE ("tenderId", "bidderId"), CONSTRAINT "PK_3235b03e8604ec822fd33114843" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "eqc_preliminary_examinations" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "criteria" character varying NOT NULL, "order" integer NOT NULL, "itbDescription" character varying, "itbReference" character varying NOT NULL, "isRequired" boolean NOT NULL, "requirementCondition" character varying NOT NULL, "type" character varying NOT NULL, "bidFormId" uuid NOT NULL, "spdEqcPreliminaryExaminationId" uuid, CONSTRAINT "PK_5ef92ca75ba18d713bde11530eb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "milestones_trackers" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid NOT NULL, "milestoneType" text NOT NULL, "actualStartDate" TIMESTAMP WITH TIME ZONE, "actualEndDate" TIMESTAMP WITH TIME ZONE, "timeStamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_f24c9f1797cfd09afb32dd1501d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tender_milestones" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid, "tenderId" uuid NOT NULL, "milestoneNum" "public"."tender_milestones_milestonenum_enum" NOT NULL, "milestoneTxt" "public"."tender_milestones_milestonetxt_enum" NOT NULL, "isCurrent" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_dee4d72868fb9237de5ee8cfc86" UNIQUE ("lotId", "milestoneNum", "isCurrent"), CONSTRAINT "PK_34e8e1d5c7287e32f12e68ea4b8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "exchange_rate_details" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "exchangeRateId" uuid NOT NULL, "localCurrency" character varying NOT NULL, "foreignCurrency" character varying NOT NULL, "rate" integer NOT NULL, CONSTRAINT "PK_da1b428b72980c3470fc55b6bf4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "exchange_rates" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "lotId" uuid, "dateOfConversion" TIMESTAMP WITH TIME ZONE NOT NULL, "source" character varying NOT NULL, CONSTRAINT "PK_33a614bad9e61956079d817ebe2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."formula_units_type_enum" AS ENUM('ADDITION', 'DEDUCTION', 'TAXES', 'TOTAL')`,
    );
    await queryRunner.query(
      `CREATE TABLE "formula_units" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "representation" character varying NOT NULL, "lotId" uuid NOT NULL, "type" "public"."formula_units_type_enum" NOT NULL, CONSTRAINT "UQ_ac6f68dd4ed008a238108020991" UNIQUE ("lotId", "name"), CONSTRAINT "PK_c1d09c9a75f3168ccafdab6df50" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."lots_status_enum" AS ENUM('ACTIVE', 'CANCELED', 'RE-ADVERTISED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "lots" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenderId" uuid NOT NULL, "number" integer NOT NULL, "name" character varying NOT NULL, "status" "public"."lots_status_enum" NOT NULL DEFAULT 'ACTIVE', "metadata" jsonb, CONSTRAINT "PK_2bb990a4015865cb1daa1d22fd9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tenders" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "procurementCategory" character varying, "procurementReferenceNumber" character varying, "budgetAmount" numeric NOT NULL DEFAULT '0', "budgetAmountCurrency" character varying NOT NULL, "budgetCode" character varying NOT NULL, "prId" character varying NOT NULL, "marketEstimate" numeric NOT NULL DEFAULT '0', "marketEstimateCurrency" character varying NOT NULL, "status" "public"."tenders_status_enum" NOT NULL DEFAULT 'DRAFT', "metadata" jsonb, "organizationId" character varying NOT NULL, "organizationName" character varying NOT NULL, "tenderDocument" jsonb, "tenderInvitation" jsonb, CONSTRAINT "PK_13fdd4229818a97b5102199463b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "offered_item_summaries" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" numeric(14,2) NOT NULL DEFAULT '0', "amount" numeric(14,2) NOT NULL DEFAULT '0', "offeredPrice" numeric(14,2) NOT NULL DEFAULT '0', "tax" numeric NOT NULL, "currency" character varying NOT NULL, "exchangeRate" numeric(14,2) NOT NULL DEFAULT '0', "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_9248ba36f9fd3d6a45d9317ee5c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "offered-item-breakdowns" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "organizationId" uuid NOT NULL, "organizationName" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "billOfQuantityId" uuid NOT NULL, "parentCode" character varying, "code" character varying NOT NULL, "category" character varying NOT NULL, "adjustedQuantity" numeric(14,2) NOT NULL DEFAULT '0', "offeredUnitPrice" numeric(14,2) NOT NULL DEFAULT '0', "originalQuantity" numeric(14,2) DEFAULT '0', "totalAmount" numeric(14,2) NOT NULL DEFAULT '0', "currency" character varying NOT NULL, "exchangeRate" numeric(14,2) DEFAULT '0', CONSTRAINT "PK_446cea4e282e76ce79994369e3e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "offered_item_summaries"`);
