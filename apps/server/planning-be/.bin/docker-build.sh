...
docker build -f apps/server/planning-be/Dockerfile -t planning-be .


# Tag the Docker image with a custom repository and tag
docker tag planning-be:latest gitlab.peragosystems.com:5050/megp/megp/planning-be:latest

# Push the tagged Docker image to the remote repository
docker push gitlab.peragosystems.com:5050/megp/megp/planning-be:latest
