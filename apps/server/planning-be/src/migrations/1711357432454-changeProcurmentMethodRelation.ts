...
export class ChangeProcurmentMethodRelation1711357432454
  implements MigrationInterface
{
  name = 'ChangeProcurmentMethodRelation1711357432454';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "procurement_mechanisms" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "procurement_requisition_documents" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_budget_plan_items" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_budget_plan_timelines" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_budget_plan_requisitioners" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_procurement_mechanisms" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_budget_activity_documents" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_plans" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_budget_lines" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "item_budget_line" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_plan_items" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_plan_timelines" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_plan_disbursements" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_activity_documents" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_plan_requisitioners" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_procurement_mechanisms" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_plan_activities" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "reasons" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_budget_plan_activities" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_budget_plans" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "budget_years" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "apps" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "budget" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "procurement_requisition_items" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "procurement_requisition_technical_teams" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "procurement_requisition_timelines" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "procurement_requisitions" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "documents" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
      `ALTER TABLE "hash" ADD "organizationName" character varying NOT NULL DEFAULT 'DefaultOrganization'`,
    );
    await queryRunner.query(
