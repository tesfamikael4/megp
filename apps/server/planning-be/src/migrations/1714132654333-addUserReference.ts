...
export class AddUserReference1714132654333 implements MigrationInterface {
  name = 'AddUserReference1714132654333';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "post_budget_plan_activities" ADD "userReference" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_budget_plan_activities" ADD CONSTRAINT "UQ_970044ea41c1a6649f15c2ee025" UNIQUE ("userReference")`,
    );
    await queryRunner.query(
      `ALTER TABLE "pre_budget_plan_activities" ADD "userReference" character varying`,
    );
    await queryRunner.query(
