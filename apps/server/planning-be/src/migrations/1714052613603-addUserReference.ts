...
export class AddUserReference1714052613603 implements MigrationInterface {
  name = 'AddUserReference1714052613603';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "procurement_requisitions" ADD "isUsed" boolean NOT NULL`,
    );
    await queryRunner.query(
