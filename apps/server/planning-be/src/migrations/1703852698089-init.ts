...
export class Init1703852698089 implements MigrationInterface {
  name = 'Init1703852698089';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "pre_budget_plan_activities" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "organizationId" uuid, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "preBudgetPlanId" uuid NOT NULL, "name" character varying NOT NULL, "procurementReference" character varying NOT NULL, "description" character varying NOT NULL, "estimatedAmount" bigint NOT NULL DEFAULT '0', "calculatedAmount" bigint NOT NULL DEFAULT '0', "currency" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'Draft', "isMultiYear" boolean NOT NULL, "remark" character varying, "classification" jsonb, CONSTRAINT "UQ_61fabba5759b9ea169407a38a2d" UNIQUE ("procurementReference"), CONSTRAINT "PK_7a336b2f4838086a7c819a19abc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "post_budget_plan_activities" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "organizationId" uuid, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "postBudgetPlanId" uuid NOT NULL, "name" character varying NOT NULL, "procurementReference" character varying NOT NULL, "description" character varying NOT NULL, "estimatedAmount" bigint NOT NULL DEFAULT '0', "calculatedAmount" bigint NOT NULL DEFAULT '0', "status" character varying NOT NULL DEFAULT 'Draft', "currency" character varying NOT NULL, "isMultiYear" boolean NOT NULL, "remark" character varying, "classification" jsonb, CONSTRAINT "UQ_ad1143400a9a09b9b8d52985f1f" UNIQUE ("procurementReference"), CONSTRAINT "PK_79a334af6584c8ba10c27e751ed" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
