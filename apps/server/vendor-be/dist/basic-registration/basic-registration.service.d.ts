...
export declare class BasicRegistrationService {
    ...
    constructor(repository: Repository<BasicRegistration>, securityQuestionRepository: Repository<SecurityQuestion>);
    registerVendor(user: any, formFields: any): Promise<void>;
    create(accountInformation: CreateBasicRegistrationDto): Promise<BasicRegistrationResponseDto>;
    findAll(query: CollectionQuery): Promise<DataResponseFormat<BasicRegistrationResponseDto>>;
    findOne(id: string): Promise<BasicRegistrationResponseDto>;
    update(id: string, accountInformation: UpdateBasicRegistrationDto): Promise<BasicRegistrationResponseDto>;
