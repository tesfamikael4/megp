...
export declare class CreateSecurityQuestionDto {
    ...
    static fromDtos(securityQuestionDto: CreateSecurityQuestionDto[]): SecurityQuestion[];
}
...
export declare class SecurityQuestionResponseDto extends UpdateSecurityQuestionDto {
    ...
    static toDtos(securityQuestions: SecurityQuestion[]): SecurityQuestionResponseDto[];
}
