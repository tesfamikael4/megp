...
export declare class CreateBasicRegistrationDto {
  ...
  country: string;
  static fromDto(
    accountInformationDto: CreateBasicRegistrationDto,
  ): BasicRegistration;
  static fromDtos(
    accountInformationDto: CreateBasicRegistrationDto[],
  ): BasicRegistration[];
...
export declare class UpdateBasicRegistrationDto extends CreateBasicRegistrationDto {
  ...
  static fromDto(
    accountInformationDto: UpdateBasicRegistrationDto,
  ): BasicRegistration;
}
export declare class BasicRegistrationResponseDto extends UpdateBasicRegistrationDto {
  static toDto(
    accountInformation: BasicRegistration,
  ): BasicRegistrationResponseDto;
  static toDtos(
    accountInformations: BasicRegistration[],
  ): BasicRegistrationResponseDto[];
}
