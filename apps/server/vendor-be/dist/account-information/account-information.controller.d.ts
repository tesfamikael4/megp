...
export declare class AccountInformationController {
  ...
  create(
    createAccountInformationDto: CreateAccountInformationDto,
  ): Promise<
    import('./dto/account-information.dto').AccountInformationResponseDto
  >;
  findOne(
    id: string,
  ): Promise<
  ...
  >;
  editBasicRegistration(
    id: string,
    createBasicRegistrationDto: UpdateBasicRegistrationDto,
  ): Promise<
    import('./dto/basic-registration.dto').BasicRegistrationResponseDto
  >;
