...
export class InvoiceEntityUpdates1709710709380 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "businessAreaId"`);
        await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "applicationNo"`);
        await queryRunner.query(`ALTER TABLE "invoice" DROP COLUMN "pricingId"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "invoice" ADD "pricingId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "invoice" ADD "applicationNo" character varying`);
