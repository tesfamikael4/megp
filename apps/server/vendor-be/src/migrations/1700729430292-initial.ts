...
export class Initial1700729430292 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "business_areas" ADD CONSTRAINT "FK_230a8b1026c3d39f6cd9693312d" FOREIGN KEY ("vendorId") REFERENCES "isr_vendors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "business_areas" DROP CONSTRAINT "FK_230a8b1026c3d39f6cd9693312d"`);
