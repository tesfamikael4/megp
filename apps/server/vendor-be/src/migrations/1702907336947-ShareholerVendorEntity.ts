...
export class ShareholerVendorEntity1702907336947 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "isr_vendors" DROP CONSTRAINT "REL_5b926a7c29cb4b0a8e68310c2c"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "isr_vendors" ADD CONSTRAINT "REL_5b926a7c29cb4b0a8e68310c2c" UNIQUE ("vendorId")`);
