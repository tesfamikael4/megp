...
export class Initial1699980561925 implements MigrationInterface {
  name = 'Initial1699980561925';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "task_handlers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "taskId" uuid NOT NULL, "instanceId" uuid NOT NULL, "handlerUserId" character varying, "handlerName" character varying, "previousHandlerId" character varying, "pickedAt" TIMESTAMP, "data" jsonb, "currentState" character varying NOT NULL, "assignmentStatus" character varying NOT NULL DEFAULT 'Unpicked', CONSTRAINT "REL_55dc9b76aa5f000b2c76701827" UNIQUE ("instanceId"), CONSTRAINT "PK_0b5474cb0a041cb84e39ab5d77a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "label" character varying, "description" text, "bpId" uuid NOT NULL, "handlerType" character varying NOT NULL, "taskType" character varying NOT NULL, "checkList" jsonb, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "task_trackers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "taskId" uuid NOT NULL, "instanceId" uuid NOT NULL, "data" jsonb, "handlerUserId" character varying, "handlerName" character varying, "pickedAt" TIMESTAMP, "action" character varying NOT NULL, "remark" character varying, "previousHandlerId" character varying, "checklists" jsonb, "executedAt" TIMESTAMP, CONSTRAINT "PK_4a2d9baad0278dde8c1cf7f5757" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "workflow_instances" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "applicationNumber" character varying NOT NULL, "requestorId" uuid, "status" character varying NOT NULL DEFAULT 'Submitted', "bpId" uuid NOT NULL, "serviceId" character varying, "businessStatus" character varying, "submittedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "pricingId" uuid, CONSTRAINT "PK_90cc94e44ff8b7b7869f50e4fc4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "vendors" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tin" character varying, "userId" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'draft', "formOfEntity" character varying, "country" character varying NOT NULL DEFAULT 'Malian', "metaData" json, "name" character varying, "level" character varying, "origin" character varying, "district" character varying, CONSTRAINT "PK_9c956c9797edfae5c6ddacc4e6e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "workflow_instances" ADD CONSTRAINT "FK_40751c4f7424c4ffb7430332375" FOREIGN KEY ("requestorId") REFERENCES "vendors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
