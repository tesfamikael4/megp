import { Controller, UseGuards, Get, Body, Param, Post, Put, UseInterceptors, UploadedFile, Delete, UploadedFiles } from "@nestjs/common";
...
export class PreferentailTreatmentsController extends EntityCrudController<PreferentialTreatmentsEntity>(options) {
    ...
    async submitApplication(
        @UploadedFiles() files: { certificate: Express.Multer.File[], otherDocuments: Express.Multer.File[] },
    ...
    async deleteDraftPreferetialTretment(@Param('id') id: string, @CurrentUser() user: any) {
