...
//additional 
const RegistrationCertificate =async ({basicInfo,businessClass, preferentials, qrCodeUrl}:{basicInfo:any[],businessClass:any[], preferentials:any[], qrCodeUrl:any}) => {
    ...
    <Page size="A4" style={styles.page}>
      <View>
        ...
        <View style={{ padding: 15 }}>
          ...
          <Text style={{paddingLeft: 14, fontWeight: 'ultrabold',fontSize: 12  }}>
          ...
          >
            ...
            <Text style={{ fontSize: 8, marginTop: 8, width: 220, paddingLeft: 80}}>
