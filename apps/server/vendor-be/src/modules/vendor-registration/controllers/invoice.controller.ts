...
export class InvoicesController {
    ...
    async getMyInvoice(@CurrentUser() userInfo: any) {
        const serviceKeys = [ServiceKeyEnum.servicesUpgrade, ServiceKeyEnum.goodsUpgrade, ServiceKeyEnum.worksUpgrade]
        return await this.invoiceService.getMyActiveInvoices(userInfo.id, serviceKeys);
    }
    ...
    async getMyRenewalInvoice(@CurrentUser() userInfo: any) {
        const serviceKeys = [ServiceKeyEnum.servicesRenewal, ServiceKeyEnum.goodsRenewal, ServiceKeyEnum.worksRenewal]
        return await this.invoiceService.getMyActiveInvoices(userInfo.id, serviceKeys);
