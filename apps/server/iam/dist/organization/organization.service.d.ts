...
export declare class OrganizationService {
    ...
    constructor(repository: Repository<Organization>, unitRepository: Repository<Unit>, employeeRepository: Repository<Employee>);
    ...
    update(id: string, organization: UpdateOrganizationDto): Promise<OrganizationResponseDto>;
    findAll(query: CollectionQuery): Promise<DataResponseFormat<OrganizationResponseDto>>;
    ...
    updateEmployee(id: string, employee: UpdateEmployeeDto): Promise<EmployeeResponseDto>;
