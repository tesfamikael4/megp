...
export const roleSystems = [
  ...
  //   key: 'INTERNAL_PROCUREMENT_AND_DISPOSAL_COMMITTEE',
  // },
  // { id: 13, name: 'HPDU', description: 'HPDU', key: 'HPDU' },
  // {
  //   id: 14,
  //   name: 'PPDA Plan Approver',
  //   description: 'PPDA Plan Approver',
  ...
  //   key: 'INTERNAL_PROCUREMENT_AND_DISPOSAL_COMMITTEE',
  // },
  // { id: 20, name: 'HPDU', description: 'HPDU', key: 'HPDU' },
  // {
  //   id: 21,
  //   name: 'PPDA Plan Approver',
  //   description: 'PPDA Plan Approver',
...
export const roleSystemPermissions = [
  ...
  // { roleSystemId: 10, permissionId: 37 },
  // { roleSystemId: 10, permissionId: 38 },
  // { roleSystemId: 10, permissionId: 39 },
  // { roleSystemId: 10, permissionId: 40 },
  // { roleSystemId: 11, permissionId: 41 },
  // { roleSystemId: 11, permissionId: 42 },
  // { roleSystemId: 11, permissionId: 43 },
  // { roleSystemId: 11, permissionId: 44 },
  ...
  // { roleSystemId: 13, permissionId: 49 },
  // { roleSystemId: 13, permissionId: 50 },
  // { roleSystemId: 13, permissionId: 51 },
  // { roleSystemId: 13, permissionId: 52 },
  // { roleSystemId: 13, permissionId: 53 },
  // { roleSystemId: 14, permissionId: 54 },
  // { roleSystemId: 14, permissionId: 55 },
  // { roleSystemId: 14, permissionId: 56 },
  // { roleSystemId: 15, permissionId: 57 },
  // { roleSystemId: 15, permissionId: 58 },
  // { roleSystemId: 15, permissionId: 59 },
  // { roleSystemId: 16, permissionId: 60 },
  // { roleSystemId: 17, permissionId: 61 },
  // { roleSystemId: 17, permissionId: 62 },
  // { roleSystemId: 17, permissionId: 63 },
  // { roleSystemId: 17, permissionId: 64 },
  // { roleSystemId: 18, permissionId: 65 },
  // { roleSystemId: 18, permissionId: 66 },
  // { roleSystemId: 18, permissionId: 67 },
  // { roleSystemId: 18, permissionId: 68 },
  // { roleSystemId: 19, permissionId: 69 },
  // { roleSystemId: 19, permissionId: 70 },
  // { roleSystemId: 20, permissionId: 71 },
  // { roleSystemId: 20, permissionId: 72 },
  // { roleSystemId: 20, permissionId: 73 },
  // { roleSystemId: 20, permissionId: 74 },
  // { roleSystemId: 20, permissionId: 75 },
  // { roleSystemId: 20, permissionId: 76 },
  // { roleSystemId: 20, permissionId: 77 },
  // { roleSystemId: 21, permissionId: 78 },
  // { roleSystemId: 21, permissionId: 79 },
  // { roleSystemId: 21, permissionId: 80 },
  // { roleSystemId: 22, permissionId: 81 },
  // { roleSystemId: 22, permissionId: 82 },
  // { roleSystemId: 22, permissionId: 83 },
  // { roleSystemId: 23, permissionId: 84 },
];
