...
export class ProcurementInstitution1710414315717 implements MigrationInterface {
  name = 'ProcurementInstitution1710414315717';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ipdc" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "organizationId" uuid, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "procurementInstitutionId" uuid NOT NULL, "status" character varying NOT NULL DEFAULT 'Draft', "name" character varying NOT NULL, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, CONSTRAINT "PK_2e5467e07f08bf571ae75254624" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
