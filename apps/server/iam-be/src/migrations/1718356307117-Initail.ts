...
export class Initail1718356307117 implements MigrationInterface {
  name = 'Initail1718356307117';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "account_credentials" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "password" text, "accountId" uuid NOT NULL, CONSTRAINT "UQ_e864d70a3409c020cd5de386aab" UNIQUE ("accountId"), CONSTRAINT "REL_e864d70a3409c020cd5de386aa" UNIQUE ("accountId"), CONSTRAINT "PK_6ec9ecef3e1cfd2fa106e0e2f0b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "account_credentials" ADD CONSTRAINT "FK_e864d70a3409c020cd5de386aab" FOREIGN KEY ("accountId") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "account_credentials" DROP CONSTRAINT "FK_e864d70a3409c020cd5de386aab"`,
    );
    await queryRunner.query(
