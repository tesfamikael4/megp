...
export class CreateOrganizationMandateDto {
  ...
  static fromDto(organizationMandateDto: CreateOrganizationMandateDto): OrganizationMandate {
  ...
  static fromDtos(organizationMandateDto: CreateOrganizationMandateDto[]) {
    return organizationMandateDto?.map(organizationMandate => CreateOrganizationMandateDto.fromDto(organizationMandate));
  }
}
...
export class UpdateOrganizationMandateDto extends CreateOrganizationMandateDto {
  ...
  static fromDto(organizationMandateDto: UpdateOrganizationMandateDto): OrganizationMandate {
    const organizationMandate: OrganizationMandate = new OrganizationMandate();  
    if (!organizationMandateDto) {
      return;
    }
...
export class OrganizationMandateResponseDto extends UpdateOrganizationMandateDto {
  ...
  static toDto(organizationMandate:OrganizationMandate): OrganizationMandateResponseDto {
    const organizationMandateDto: OrganizationMandateResponseDto = new OrganizationMandateResponseDto();  
  ...
  static toDtos(organizationMandates:OrganizationMandate[]) {
    return organizationMandates?.map(organizationMandate => OrganizationMandateResponseDto.toDto(organizationMandate));
  }
}