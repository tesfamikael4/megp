...
export class CreateMandatePermissionDto {
  ...
  static fromDto(mandatePermissionDto: CreateMandatePermissionDto): MandatePermission {
  ...
  static fromDtos(mandatePermissionDto: CreateMandatePermissionDto[]) {
    return mandatePermissionDto?.map(mandatePermission => CreateMandatePermissionDto.fromDto(mandatePermission));
  }
}
...
export class UpdateMandatePermissionDto extends CreateMandatePermissionDto {
  ...
  static fromDto(mandatePermissionDto: UpdateMandatePermissionDto): MandatePermission {
    const mandatePermission: MandatePermission = new MandatePermission();  
    if (!mandatePermissionDto) {
      return;
    }
...
export class MandatePermissionResponseDto extends UpdateMandatePermissionDto {
  ...
  static toDto(mandatePermission:MandatePermission): MandatePermissionResponseDto {
    const mandatePermissionDto: MandatePermissionResponseDto = new MandatePermissionResponseDto();  
  ...
  static toDtos(mandatePermissions:MandatePermission[]) {
    return mandatePermissions?.map(mandatePermission => MandatePermissionResponseDto.toDto(mandatePermission));
  }
}