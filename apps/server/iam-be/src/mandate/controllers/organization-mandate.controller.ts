...
import {
  ...
  UpdateOrganizationMandateDto,
} from '../dto/organization-mandate.dto';
...
export class OrganizationMandateController extends GenericCrudController<OrganizationMandate> {
  ...
  @Post()
  async create(
    @Body() createOrganizationMandateDto: CreateOrganizationMandateDto,
  ): Promise<OrganizationMandate> {
