...
constructor(private readonly organizationService: OrganizationService) {}
  ...
  @Patch(':id')
  async update(@Param('id', new ParseUUIDPipe({ errorHttpStatusCode: HttpStatus.NOT_ACCEPTABLE })) id: string, @Body() updateOrganizationDto: UpdateOrganizationDto) {
  ...
  async editUnit(@Param('id', new ParseUUIDPipe({ errorHttpStatusCode: HttpStatus.NOT_ACCEPTABLE })) id: string, @Body() createUnitDto: UpdateUnitDto) {
    return await this.organizationService.updateUnit(id, createUnitDto);
  }

  @Delete('remove-unit/:id')
  async removeUnit(@Param('id', new ParseUUIDPipe({ errorHttpStatusCode: HttpStatus.NOT_ACCEPTABLE })) id: string) {
  ...
  async editEmployee(@Param('id', new ParseUUIDPipe({ errorHttpStatusCode: HttpStatus.NOT_ACCEPTABLE })) id: string, @Body() createEmployeeDto: UpdateEmployeeDto) {
    return await this.organizationService.updateEmployee(id, createEmployeeDto);
  }

  @Delete('remove-employee/:id')
  async removeEmployee(@Param('id', new ParseUUIDPipe({ errorHttpStatusCode: HttpStatus.NOT_ACCEPTABLE })) id: string) {
