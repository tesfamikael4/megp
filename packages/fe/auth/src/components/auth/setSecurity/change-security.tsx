...
import { TextInput, PasswordInput, Button, Select, Stack } from '@mantine/core';
import z from 'zod';
  ...
  return (
    <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
      <Stack gap={4}>
        ...
        {mode === 'new' && (
          <Button h={40} loading={isSetting} mt={15} type="submit">
            Submit
          </Button>
        )}
        {mode === 'update' && (
        ...
        {mode === 'reset-password' && (
          <Button h={40} loading={isChecking} mt={15} type="submit">
            Reset Password
          </Button>
        )}
      </Stack>
